...
| ZFS pool | `nas-01` |
| NFS parent dataset | `nas-01/nfs/k8s/onprem-prod` |
| iSCSI parent dataset | `nas-01/block/k8s/onprem-prod` (future) |
...
`kubernetes/infrastructure/onprem-prod/democratic-csi-nfs/sealed-secret.yaml`
